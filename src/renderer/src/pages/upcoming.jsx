...
import { faArrowRight, faPenToSquare, faPlus, faEye, faEyeSlash } from "@fortawesome/free-solid-svg-icons";
...
function Today() {
  ...
  const onSuccessNewTask = () => {fetchUpcomingTasks()}
  ...
  const fetchUpcomingTasks = async () => {
    ...
    try {
      const tasksResponse = await window.api.getUpcomingTasks(user_id)
      console.log('tasksResponse', tasksResponse);
      if (tasksResponse.status === 200){
        setUpcomingTasks(tasksResponse.tasks)
      }
    } catch (error) {
    ...
    <div className="page-wrapper">
      <div className="page-box">
        ...
        <div className="d-flex listinfo">
            <FontAwesomeIcon className="mr-3 header-icon" style={{ marginTop: "0.1em" }} icon={faCircleUp} />
            <h1>Upcoming</h1>
        </div>
        <div className="mt-2">
        ...
        <div className="mt-5">
                ...
                {upcomingTasks.length > 0 ? (
                    ...
                    <h6 style={{ fontSize: "0.8em" }}><em>You have no upcoming tasks</em></h6>
                )}
                <div>
